...
<nav className="bg-white border-b border-gray-200">
  <div className="max-w-screen-xl mx-auto px-2 py-3 flex items-center justify-between flex-nowrap">
    ...
    <ul className="flex items-center font-outfit font-semibold whitespace-nowrap
      ...
      <li><a href="/service" className="hover:text-blue-700 m-2">Services</a></li>
      <li><a href="/pricing" className="hover:text-blue-700 m-2">Pricing</a></li>
      <li><a href="/contact" className="hover:text-blue-700 m-2">Contact</a></li>
      <li><a href="/team" className="hover:text-blue-700 m-2">Team</a></li>
    </ul>
